<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="{{ env('APP_NAME') }}的博客，用于记录生活点滴。写一些技术博客和游戏博客，记录自己学到的玩到的，自己喜欢的东西。尽可能地留下自己脚印。人生开心就好。学到老，玩到老，笑到老。哈哈哈哈哈哈哈哈">
        <meta name="keyword" contet="记录生活点滴,{{ env('APP_NAME') }},laravel博客,php博客,技术博客,个人博客">
